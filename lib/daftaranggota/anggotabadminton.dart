...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: AnggotaBadminton(),
    );
  }
}

class AnggotaBadminton extends StatefulWidget {
  @override
  _AnggotaBadmintonState createState() => _AnggotaBadmintonState();
}

class _AnggotaBadmintonState extends State<AnggotaBadminton> {
